...
export const repoMetadata: Record<string, RepoMetadata> = {
  ...
  "simple-pool": {
    repo: "Microck/simple-pool",
    sourceUrl: "https://github.com/Microck/simple-pool",
    livePreviewUrl: null,
    isPrivate: false,
  },
  solecist: {
  ...
  "t3-chat-zipper": {
    ...
    livePreviewLabel: "Download userscript",
    isPrivate: false,
  },
  traccia: {
